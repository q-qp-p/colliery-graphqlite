---
id: c3-write-contributing-md-build
level: task
...
# C3: Write CONTRIBUTING.md (build/test taxonomy, ownership conventions, pre-push checklist)
...
- [ ] Covers all five topics listed above.
