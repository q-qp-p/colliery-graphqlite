/*
 * transform_func_temporal.c
 *    Temporal value construction, parsing, truncation, and arithmetic
 *    (date/time/datetime/localdatetime/duration). Moved from
 *    transform_func_list.c (I-0040 M8).
 */
...
/* SQL emission helpers used by the truncate/duration code paths.
 * Lifted from transform_func_list.c during the I-0040 M8 split. */
